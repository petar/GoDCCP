...
func (c *Conn) inject(h *Header) {
	...
	c.logger.E("Write", "Non-data to injection queue", h)
...
func (c *Conn) writeLoop(writeNonData chan *Header, writeData chan []byte) {
	...
	c.logger.E("Event", "Write Loop I", nil)
_Loop_I:
	...
	c.logger.E("Event", "Write Loop II")
_Loop_II:
	...
	c.logger.E("Event", "Write Loop III")
_Loop_III:
...
_Exit:
	c.logger.E("Event", "Write loop EXIT")
}
