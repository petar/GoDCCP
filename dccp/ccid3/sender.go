...
func (s *ccid3sender) OnWrite(htype byte, x bool, seqno int64) (ccval byte, options []*Option) {
	?
}
...
func (s *ccid3sender) OnRead(htype byte, x bool, seqno int64, options []*Option) os.Error {
	?
}
